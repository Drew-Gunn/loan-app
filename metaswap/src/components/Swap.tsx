...
export const Swap: React.FC = () => {
    const TOKEN_ADDRESSES = {
     SDT: '0x66d850bf3a7F3Ec49CD8df0bd8a1c7FCBD77FdB4',
     SKT: '0xA177c49748759C809ae9239Fa36E08AE9DBbdDd9',
    };
   
    const TOKENSWAP_CONTRACT_ADDRESS = '0xfcfe90f391d13048FCD1ff8336a236DCbFe2b38F';
